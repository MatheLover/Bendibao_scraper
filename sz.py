...
# base url for each city
url_1 = 'http://m.bendibao.com/'

# url of first page on covid-19 policy given the city
url_2 = 'http://m.bendibao.com/news/list.php?sid=17&cid=1720'

# base url given the news article and the city
url_3 = 'http://m.bj.bendibao.com/'
...
if __name__ == "__main__":
    ...
    div_tag_list = soup.find_all("div", class_="sec-list-body")
